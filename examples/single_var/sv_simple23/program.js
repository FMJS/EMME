...
var x = new Float64Array(data.x_sab); id2_R_t1 = x[0]; print("id2_R_t1: "+id2_R_t1.toFixed(2));
var x = new Float32Array(data.x_sab); x[0] = 1.00;
var x = new Float32Array(data.x_sab); x[1] = 1.00;
};`;
var t2 =
`onmessage = function(data) {
var x = new Float64Array(data.x_sab); id5_R_t2 = x[0]; print("id5_R_t2: "+id5_R_t2.toFixed(2));
