...
$262.agent.start(
   `$262.agent.receiveBroadcast(function (x_sab) {
      var report = [];
      var x = new Float32Array(x_sab); x[0] = 1.1000;
      var x = new Float32Array(x_sab); x[1] = 1.1000;
...
$262.agent.start(
   `$262.agent.receiveBroadcast(function (x_sab) {
      var report = [];
      var x = new Float32Array(x_sab); x[1] = 2.2000;
      var x = new Float32Array(x_sab); x[2] = 2.2000;
      $262.agent.report(report);
      $262.agent.leaving();
   })
   `);
