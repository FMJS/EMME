...
$.agent.start(
   `$.agent.receiveBroadcast(function (data) {
      var report = [];
      var x = new Float32Array(data.x_sab); x[0] = 0.50;
...
$.agent.start(
   `$.agent.receiveBroadcast(function (data) {
      ...
      var x = new Float32Array(data.x_sab); x[2] = 1.50;
      $.agent.report(report);
      $.agent.leaving();
   })
   `);
...
report = report.join(";");
var outputs = [];
outputs[0] = "id6_R_t3: 0.13;id7_R_t3: 0.50";
outputs[1] = "id6_R_t3: 0.00;id7_R_t3: 0.50";
outputs[2] = "id6_R_t3: 0.12;id7_R_t3: 0.00";
outputs[3] = "id6_R_t3: 0.00;id7_R_t3: 0.00";
outputs[4] = "id6_R_t3: 0.12;id7_R_t3: 0.50";
