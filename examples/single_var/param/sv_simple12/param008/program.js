...
$262.agent.start(
   `$262.agent.receiveBroadcast(function (data) {
      ...
      var x = new Float32Array(data.x_sab); x[2] = 0.500000;
      $262.agent.report(report);
      $262.agent.leaving();
   })
   `);
...
report = report.join(";");
var outputs = [];
outputs[0] = "id6_R_t3: 0.000032;id7_R_t3: 0.000000";
outputs[1] = "id6_R_t3: 0.000000;id7_R_t3: 1.000000";
outputs[2] = "id6_R_t3: 0.000032;id7_R_t3: 1.000000";
outputs[3] = "id6_R_t3: 0.007814;id7_R_t3: 1.000000";
outputs[4] = "id6_R_t3: 0.000000;id7_R_t3: 0.000000";
assert(-1 != outputs.indexOf(report));

// Expected outputs //
//output// id6_R_t3: 0.000032;id7_R_t3: 0.000000
//output// id6_R_t3: 0.000000;id7_R_t3: 1.000000
//output// id6_R_t3: 0.000032;id7_R_t3: 1.000000
