...
$.agent.start(
   `$.agent.receiveBroadcast(function (data) {
      ...
      var x = new Float32Array(data.x_sab); x[2] = 1.00;
      $.agent.report(report);
      $.agent.leaving();
   })
   `);
...
report = report.join(";");
var outputs = [];
outputs[0] = "id6_R_t3: 0.01;id7_R_t3: 1.50";
outputs[1] = "id6_R_t3: 0.13;id7_R_t3: 1.50";
outputs[2] = "id6_R_t3: 0.01;id7_R_t3: 0.00";
