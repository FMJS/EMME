...
var x = new Float64Array(data.x_sab); id2_R_t1 = x[0]; print("id2_R_t1: "+id2_R_t1.toFixed(6));
var x = new Float32Array(data.x_sab); x[0] = 2.000000;
var x = new Float32Array(data.x_sab); x[1] = 2.000000;
};`;
var t2 =
`onmessage = function(data) {
var x = new Float64Array(data.x_sab); id5_R_t2 = x[0]; print("id5_R_t2: "+id5_R_t2.toFixed(6));
...
//output// id2_R_t1: 0.007814;id5_R_t2: 0.000000
//output// id2_R_t1: 0.000000;id5_R_t2: 2.000000
