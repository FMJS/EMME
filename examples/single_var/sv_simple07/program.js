...
var t2 =
`onmessage = function(data) {
var x = new Float32Array(data.x_sab); x[0] = 2.200000;
};`;
var t3 =
`onmessage = function(data) {
var x = new Float32Array(data.x_sab); id4_R_t3 = x[0]; print("id4_R_t3: "+id4_R_t3.toFixed(6));
};`;
var data = {
...
//output// id4_R_t3: 2.200000
//output// id4_R_t3: 1.100000
